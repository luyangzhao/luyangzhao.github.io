...
<div class="smile-lab-preview">
  <a class="smile-lab-preview__media" href="https://smile-robotics-lab.github.io/#lab" target="_blank" rel="noopener" aria-label="Visit SMILE Robotics Lab members">
    <picture>
      <source srcset="{{ '/assets/img/teasers/smile-first-author-reel.webp' | relative_url }}?v=soft-lattice-source-1" type="image/webp">
      <img src="{{ '/assets/img/teasers/smile-first-author-reel.gif' | relative_url }}?v=soft-lattice-source-1" alt="SMILE Robotics Lab first-author research reel" loading="eager">
    </picture>
  </a>
